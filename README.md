...
[![pyversion](https://img.shields.io/pypi/pyversions/pymt5.svg)](#platform-availability)
...
__pymt5.send(<i>client_id</i>, _msg_)__  
<i>client_id: int</i>  
_msg: dict_  
...
__pymt5.onData(_msg_)__  
_msg: dict_  
A callback `onData`, if assigned, is called upon receiving messages from gateways. See [Message Format](#Message Format) for more information.
...
## Message Format
Message is to be composed as a dict with key/value defined below to be sent and received from a gateway.

Message type    | Header                | Tags
----------------|-----------------------|------
